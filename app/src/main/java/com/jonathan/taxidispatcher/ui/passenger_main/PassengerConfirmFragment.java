    ...
    private View.OnClickListener makeTransaction = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            viewModel.makeTransaction(Session.getUserId(getContext()),
                    ...
                    "")
            .observe(PassengerConfirmFragment.this, new Observer<ApiResponse<TranscationResource>>() {
                @Override
                    ...
                    public void onChanged(@Nullable ApiResponse<DirectionModel> response) {
                        ...
                        if (response.isSuccessful()) {
                            if(response.body.status.equals("OK")) {
                                binding.travelDistanceText.setText(
                                        String.valueOf(response.body.routes.get(0).legs.get(0).distance.value / 1000) + " km");
                                binding.travelTimeText.setText(
